...
SECRET_KEY = 'django-insecure-^4qt3ox$eq3ve!1@+%api%!m15g$gfacz280^bj&+#!+_-_l(t'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]  # Directory to store static files in development
